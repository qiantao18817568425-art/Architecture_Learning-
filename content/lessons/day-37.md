...
计划学习日期：2026-09-28，星期一，Asia/Shanghai。材料提前发布于 2026-09-26；当前为预备材料，不计入周六/周日已学范围。课程序列：Audio 第四课；新周编号在正式安排时核对。能力阶段：第二阶段“系统链路与问题分析”。预计深度：L3；恢复方案尝试 L4。
...
| 下一任务 | 正式安排后按当日星期与总控队列决定；周五至周日仅复盘，不以本预备课推定已经学习 |
...
后续安排以真实星期为准：本材料正式进入工作日课程后，周一至周四按队列推进；周五总结，周六与周日巩固，不因预备材料已发布提前扩展周末范围。
